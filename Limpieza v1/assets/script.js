...
document.addEventListener('DOMContentLoaded', function() {
    // Verificar si estamos en la página servicios.php antes de continuar
    if (!document.querySelector('#servicios2')) {
        // Salir del script si no estamos en la página servicios.php
        return;
    }
    ...
    function iniciarIntervalo() {
        intervalo = setInterval(activarSiguienteServicio, 3000); // Cambia cada 3 segundos
    }
